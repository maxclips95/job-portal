          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4">
              {[
                ...
                <div
                  key={idx}
                  className={`bg-white rounded-lg shadow-md p-4 border-t-4 border-${
                    metric.color
                  }-500`}
                >
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                {[
                  ...
                  },
                  {
                    ...
                    percentage: (data.jobAnalytics.approved / data.jobAnalytics.total) * 100,
                    color: 'green',
                  },
                  {
                    label: 'Pending',
                    value: data.jobAnalytics.pending,
                    percentage: (data.jobAnalytics.pending / data.jobAnalytics.total) * 100,
                    color: 'yellow',
                  },
                  {
                    label: 'Rejected',
                    value: data.jobAnalytics.rejected,
                    percentage: (data.jobAnalytics.rejected / data.jobAnalytics.total) * 100,
                    color: 'red',
                  },
                  {
                    label: 'Active',
                    value: data.jobAnalytics.active,
                    percentage: (data.jobAnalytics.active / data.jobAnalytics.total) * 100,
                    color: 'blue',
                  },
                  {
                    label: 'Expired',
                    value: data.jobAnalytics.expired,
                    percentage: (data.jobAnalytics.expired / data.jobAnalytics.total) * 100,
                    color: 'gray',
                  },
                ].map((stat, idx) => (
              ...
              <div className="space-y-3">
                ...
                <div className="p-4 bg-indigo-50 border-l-4 border-indigo-500 rounded">
                  <p className="text-sm text-indigo-900">
                    ...
                    hours ({
                      (
                        (data.userAnalytics.activeToday /
