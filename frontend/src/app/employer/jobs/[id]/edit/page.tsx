  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await jobService.updateJob(jobId, {
        ...
        deadline: new Date(formData.deadline) as any,
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-2 gap-6">
              ...
              <div>
                ...
                <select name="subcategory_id" value={formData.subcategory_id} onChange={handleInputChange} required className="w-full px-4 py-2 border border-gray-300 rounded-lg">
            ...
            <div className="flex gap-4">
              <button type="submit" disabled={saving || !canSubmit} className="flex-1 bg-blue-600 text-white py-3 px-6 rounded-lg hover:bg-blue-700 disabled:opacity-50">
